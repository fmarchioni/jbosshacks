== demo-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The demo-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>org.demo.addon</groupId>
   <artifactId>demo-addon</artifactId>
