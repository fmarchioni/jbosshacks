...
import org.demo.forge.model.Customer;
...
public class CustomerBean implements Serializable {
	...
	@PersistenceContext(unitName = "demo-forge-persistence-unit", type = PersistenceContextType.EXTENDED)
