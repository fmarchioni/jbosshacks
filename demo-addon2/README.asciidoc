== demo-addon2
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The demo-addon2 addon enables blah blah...)
...
----
<dependency>
   <groupId>org.demo.addon2</groupId>
   <artifactId>demo-addon2</artifactId>
